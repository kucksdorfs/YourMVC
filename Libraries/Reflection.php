...
namespace YourMVC {
     ...
     * @author stephen
     */
    interface iRelfection {
        // Inquery methods
        static function HasInstanceMethod($object,$methodName);

        static function HasStaticMethod($className,$methodName);

        static function HasInstanceMember($object,$memberName);

        static function HasStaticMember($className,$memberName);
        // Invoke Methods
        static function InvokeInstanceMethod($object,$method,$parameters,&$retValue);

        static function InvokeStaticMethod($object,$method,$parameters,&$retValue);
        // Member Values
        static function GetInstanceMemberValue($object,$memberName);

        static function GetStaticMemberValue($className,$memberName);

        static function CreateNewInstance($className);
    }
    ...
    class YourReflection implements \YourMVC\iRelfection {
         ...
         * @param unknown $object - The object to find the method.
         * @param unknown $methodName - The name of the method to find.
         ...
         * @param string $methodName - The name of the static method.
         ...
         * @param object $object - The object the method should be called on
         * @param string $methodName - The name of the method to be called.
         * @param array $parameters - Parameters that should be passed to the method.
         * @param object $retValue - The return value of the object (should be null when passed in).
         ...
         * @param string $className - The name of the class the static method belongs to.
         * @param string $methodName - The name of the static method to be called.
         * @param array $parameters - Parameters that should be passed to the static method.
         * @param object $retValue - The return value of the object (should be null when passed in).
         * @return boolean - true of the method executed successfully, otherwise false.
         */
         ...
         * @param string $className - The full name of the class (namespace and classname)
         * @param array $args - Arguments to be passed into the constructor.
