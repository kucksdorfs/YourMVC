<?php
namespace YourMVC\Testing
{

    abstract class UnitTestFramework
    {
        ...
        public final static function Main($args)
        {
            ...
            for ($i = 0; $i < count($classesAfterInclude); $i ++) {
                if (! in_array($classesAfterInclude[$i], $classesBeforeInclude) && is_subclass_of($classesAfterInclude[$i], "\YourMVC\Testing\UnitTestFramework")) {
